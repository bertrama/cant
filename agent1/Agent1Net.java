...
public class Agent1Net extends CANTNet {
  public Agent1Net(){
  }

  public Agent1Net(String name,int cols, int rows,int topology){
  	super(name,cols,rows,topology);
  }

  public CANTNet getNewNet(String name,int cols, int rows,int topology){
  	Agent1Net net = new Agent1Net (name,cols,rows,topology);
	return (net);
	} 
  ...
  private CANTPattern readNewPattern() {
	...
	int [] patternPoints = new int[10000];
	int cPoints=0;
	int number;

    CANT23Agent1.bmpReader.readPicture();
    cPoints = CANT23Agent1.bmpReader.getPictureBits(patternPoints);
  ...
  public void changePattern(int cycle) {
  ...
  private void connectInputTo3x3(Agent1Net retinaNet, int start,
  ...
  private void connectInputTo6x6(Agent1Net retinaNet, int start,
                                   double onVal, double offVal) {
  int row;
  int column;
  ...
  private void connectInputTo9x9(Agent1Net retinaNet, int start,
                                   double onVal, double offVal) {
  int row;
  int column;
  ...
  public void connectInputToRetina(Agent1Net retinaNet) {
  ...
  private void connectRetinaToHorizontal(Agent1Net V1Net, 
  ...
  private void connectRetinaToSlash(Agent1Net V1Net, double onOff33Val) 
  {
    int row;
    int column;
    for (int inputNeuron = 0; inputNeuron < 900; inputNeuron++) 
  ...
  private void connectRetinaToBackSlash(Agent1Net V1Net, double onOff33Val) 
  {
    int row;
    int column;
    for (int inputNeuron = 0; inputNeuron < 900; inputNeuron++) 
  ...
  private void connectRetinaToAndAngle(Agent1Net V1Net, double onOff66Val) 
  {
    int row;
    int column;
  ...
  private void connectRetinaToLessThanAngle(Agent1Net V1Net, double onOff66Val) 
  {
    int row;
    int column;
    for (int inputNeuron = 1800; inputNeuron < 2700; inputNeuron++) 
  ...
  private void connectRetinaToGreaterThanAngle(Agent1Net V1Net, double onOff66Val) 
  {
    int row;
    int column;
    for (int inputNeuron = 1800; inputNeuron < 2700; inputNeuron++) 
  ...
  private void connectRetinaToOrAngle(Agent1Net V1Net, double onOff66Val) 
  {
    int row;
    int column;
    for (int inputNeuron = 1800; inputNeuron < 2700; inputNeuron++) 
  ...
  private void connectRetinaToEdge (Agent1Net V1Net) 
  {
    int row;
    int column;
    ...
    for (int inputNeuron = 0; inputNeuron < 900; inputNeuron++) 
      ...
      addOneRetinaConnection(row,column,V1Net.neurons[6300+inputNeuron],onVal);
      
      addOneRetinaConnection(row-1,column-1,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row-1,column,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row-1,column+1,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row,column-1,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row,column+1,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row+1,column-1,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row+1,column,V1Net.neurons[6300+inputNeuron],offVal);
      addOneRetinaConnection(row+1,column+1,V1Net.neurons[6300+inputNeuron],offVal);
  ...
  public void connectRetinaToV1(Agent1Net V1Net) {
    ...
    connectRetinaToEdge(V1Net);	
  }

  private void connectRetinaToAndTriangle(Agent1Net V2Net, double offOn99Val) 
  {
    int row;
    int column;
	int triangleRow;
  ...
  private void connectRetinaToOrTriangle(Agent1Net V2Net, double offOn99Val) 
  {
    int row;
    int column;
    int triangleRow;
  ...
  private void connectV1ToAndTriangle(Agent1Net V2Net) 
  {
    int row;
    int column;
    int triangleRow;
  ...
  private void connectV1ToOrTriangle(Agent1Net V2Net) 
  {
    int row;
    int column;
    int triangleRow;
  ...
  public void connectRetinaToV2(Agent1Net V2Net) {
    connectRetinaToAndTriangle(V2Net,1.0);	
    connectRetinaToOrTriangle(V2Net,1.0);	
  }

  public void connectV1ToV2(Agent1Net V2Net) {
